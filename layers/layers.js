...
lyr_OpenStreetMap_0.setVisible(true);lyr_densidadpoblacionalporprovincia_1.setVisible(true);lyr_lagos_2.setVisible(true);lyr_trenes_3.setVisible(true);lyr_aeropuertos_4.setVisible(true);lyr_carreteras_5.setVisible(true);lyr_capital_6.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_densidadpoblacionalporprovincia_1,lyr_lagos_2,lyr_trenes_3,lyr_aeropuertos_4,lyr_carreteras_5,lyr_capital_6];
lyr_densidadpoblacionalporprovincia_1.set('fieldAliases', {'fid': 'fid', 'cat': 'cat', 'INSPIREID': 'INSPIREID', 'NATCODE': 'NATCODE', 'NAMEUNIT': 'nombre', 'pob_tot_es': 'población total año 2016', 'area': 'area', 'densidad': 'hab/km2', });
...
lyr_capital_6.set('fieldAliases', {'CITY_NAME': 'Ciudad', 'ADMIN_NAME': 'Capital', 'CNTRY_NAME': 'país', 'STATUS': 'tipo', 'pob': 'población', 'fundacion': 'fundación', 'moneda': 'moneda', 'idioma': 'idioma', });
...
lyr_capital_6.on('precompose', function(evt) {
